...
{
    public class T_BUSINESS_VERIFICATION_INFOMap : EntityTypeConfiguration<T_BUSINESS_VERIFICATION_INFO>
    {
        public T_BUSINESS_VERIFICATION_INFOMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.Property(t => t.PurchaseType)
                .IsRequired()
                .HasMaxLength(100);
            ...
            this.ToTable("T_BUSINESS_VERIFICATION_INFO");
