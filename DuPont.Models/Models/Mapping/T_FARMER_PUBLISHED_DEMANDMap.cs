...
{
    public class T_FARMER_PUBLISHED_DEMANDMap : EntityTypeConfiguration<T_FARMER_PUBLISHED_DEMAND>
    {
        public T_FARMER_PUBLISHED_DEMANDMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("T_FARMER_PUBLISHED_DEMAND");
            ...
            this.Property(t => t.VarietyId).HasColumnName("VarietyId");
            this.Property(t => t.AcresId).HasColumnName("AcresId");
            ...
            this.HasMany(m => m.Operators)
                .WithMany(m => m.FarmerDemandList)
                .Map(m =>
                {
                    m.ToTable("T_USER_FARMERDEMANDS");
                    m.MapLeftKey("FarmerDemandId");
