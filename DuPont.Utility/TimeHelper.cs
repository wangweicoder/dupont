...
namespace DuPont.Utility
{
    ...
    public class TimeHelper
    {
        ...
        public static DateTime GetChinaLocalTime() 
        {
            ...
            dt = TimeZoneInfo.ConvertTimeBySystemTimeZoneId(dt, "China Standard Time");
        ...
        /// <returns></returns>
        public static DateTime GetChinaLocalTime(DateTime dtTime)
        {
            DateTime dt = dtTime;
        ...
        #region 将当前时间转化成毫秒数
        public static string GetMilliSeconds(DateTime date)
        {
            DateTime baseDate = new DateTime(1970, 1, 1);
            TimeSpan timeSpan = date - baseDate - TimeSpan.FromHours(8);
